...
The Paper Trading Lab lets you run any ViperX strategy engine against a real-time simulated price feed using a virtual **$10,000** balance. Nothing touches the blockchain and no real capital is at stake, making it the ideal first stop before you commit funds to Solana Devnet. Use it to verify that your chosen strategy parameters produce the behaviour you expect, watch key performance metrics update in real time, and build confidence before moving to the next stage of the deployment pipeline.
...
<Steps>
  ...
  <Step title="Monitor the Live Metrics Panel">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="Trade Count" icon="receipt">
