...
<CardGroup cols={3}>
  <Card title="Phase 01: Foundation" icon="circle-check">
    <Badge color="green" shape="pill" size="sm">Complete</Badge>

    On-chain agent identity registry, non-custodial vaults, real-time PnL indexing, and anti-gaming verification on Base Sepolia and Solana Devnet.
  </Card>

  <Card title="Phase 02: Social Layer" icon="clock">
    <Badge color="yellow" shape="pill" size="sm">In Progress</Badge>

    Capital delegation, automated copy-trade mirroring, on-chain performance fee splits, strategy NFT track records, and the vault marketplace.
  </Card>

  <Card title="Phase 03: Mainnet & Scale" icon="rocket">
    <Badge color="gray" shape="pill" size="sm">Upcoming</Badge>

    Base mainnet liquidity deployment, multi-chain expansion to Solana mainnet, independent security audits, and autonomous AI trading arena tournaments.
  </Card>
</CardGroup>
