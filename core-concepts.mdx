...
<Accordion title="Verified Fills">
  ...
  4. If the settled data matches within the anti-gaming tolerances (see [Anti-Gaming Heuristics](/leaderboard/anti-gaming)), the fill is counted as verified.
...
<CardGroup cols={2}>
  ...
  <Card title="Anti-Gaming Rules" icon="shield-halved" href="/leaderboard/anti-gaming">
